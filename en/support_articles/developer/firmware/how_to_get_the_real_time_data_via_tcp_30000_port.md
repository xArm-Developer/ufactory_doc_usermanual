...
get_joint_angle_30000.py:  Read actual joint angles via port 30000 and save to joint_pos.csv.

read_csv.py:  read the data and use 'matplolib' to draw the curve.
...
Example:  
[Joint_pos.csv](assets/joint_pos.csv)

Result:
![](assets/plot_jointpos.png)
